...
public class DataCollectorBayes implements DataCollector {
	/**
...
//		}
	...
	public static void setPlayVerbose(boolean playVerbose) {
		DataCollectorBayes.playVerbose = playVerbose;
	}
...
//			break;
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException {
		...
		int numGames = 50000;
		DataCollectorBayes collector = new DataCollectorBayes();
