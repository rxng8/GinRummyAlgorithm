...
public class DataCollectorHandValue implements DataCollector {
	/**
	...
	public static void setPlayVerbose(boolean playVerbose) {
		DataCollectorHandValue.playVerbose = playVerbose;
	}
...
//			break;
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException {
		...
		int numGames = 50000;
		DataCollectorHandValue collector = new DataCollectorHandValue();
